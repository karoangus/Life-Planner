const CACHE_NAME='life-planner-cache-v67';
self.addEventListener('message',e=>{if(e.data&&e.data.type==='SKIP_WAITING')self.skipWaiting();});
const SHELL=['./','./index.html','./manifest.json','./icon-192.png','./icon-512.png','./app-version.json','./css/app.css','./css/design-system.css','./js/core.js','./js/enhancements.js','./js/sw-register.js','./js/pomodoro.js','./js/lang.js','./js/v16.js','./js/v162.js','./audio/city_day.ogg','./audio/city_night.ogg','./audio/city_rain.ogg','./audio/rain.mp3','./audio/forest.mp3','./audio/cafe.mp3','./audio/fire.mp3'];
