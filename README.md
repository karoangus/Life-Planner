...
<p align="center">
  <img src="https://img.shields.io/badge/نسخه-16.3-00e5ff?style=for-the-badge&logoColor=white" alt="Version 16.3" />
...
1. فایل `app-version.json` ➔ کلید `"version"` (مثلاً `"16.3"`).
2. فایل `js/core.js` ➔ `const LP_APP_VERSION = '16.3';`
3. فایل `package.json` ➔ کلید `"version"` (مثلاً `"16.3.0"`).
