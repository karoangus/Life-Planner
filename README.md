...
<p align="center">
  <img src="https://img.shields.io/badge/نسخه-16.5-00e5ff?style=for-the-badge&logoColor=white" alt="Version 16.5" />
...
1. فایل `app-version.json` ➔ کلید `"version"` (مثلاً `"16.5"`).
2. فایل `js/core.js` ➔ `const LP_APP_VERSION = '16.5';`
3. فایل `package.json` ➔ کلید `"version"` (مثلاً `"16.5.0"`).
