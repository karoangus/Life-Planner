...
if (!useFallback) {
  ...
  const hasVersionBump = (versionJson.version === '13.0' || versionJson.version === '11.2' || versionJson.version === '11.0' || versionJson.version === '10.2') && (pkgJson.version === '13.0.0' || pkgJson.version === '11.2.0' || pkgJson.version === '11.0.0' || pkgJson.version === '10.2.0') && (coreJs.includes("LP_APP_VERSION='13.0'") || coreJs.includes("LP_APP_VERSION='11.2'") || coreJs.includes("LP_APP_VERSION='11.0'") || coreJs.includes("LP_APP_VERSION='10.2'"));
